    ...
    def get_jmeter_xml(self):
        ...
        if self.queryString:
            ...
            for element in self.queryString:
                argument = Element('elementProp', name=element.get('name'), elementType="HTTPArgument")
                append_sub_element(argument, 'boolProp', 'false', name='HTTPArgument.always_encode')
                append_sub_element(argument, 'stringProp', element.get('value'), name='Argument.value')
                append_sub_element(argument, 'stringProp', '=', name='Argument.metadata')
                append_sub_element(argument, 'boolProp', 'true', name='HTTPArgument.use_equals')
                append_sub_element(argument, 'stringProp', element.get('name'), name='Argument.name')
